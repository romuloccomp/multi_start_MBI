function [ vet3d ] = gera_vet3d( data )
    ...
    %para cada linha da variavel data que é cada vetor de vacinação.
    ...
    %vacinação colocados nas colunas.
    
        %Caso deseja-se gerar a partir de determinadas duas linhas
        %Deve-se atribuir o valor das colunas (no data.dat) às seguintes variáveis
        ...
        %Caso deseja-se gerar o gráfico a partir de doto o arquivo .dat
        ...
        %Para gerar o vetor a partir de taxas aleatórias
